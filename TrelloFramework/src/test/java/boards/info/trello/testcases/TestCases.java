...
// Verify HomePage using Title
		Assert.assertEquals(webdriverUtils.getTitle(driver), excelUtils.readStringData("Sheet1", 1, 1), "Trello Homepage Title is Not Matched");
	}
...
// Verify Login Page using URL
		Assert.assertEquals(webdriverUtils.getCurrentURL(driver), excelUtils.readStringData("Sheet1", 2, 1), "Trello LoginPage URL is Not Matched");
// Verify Login Page using Title
		Assert.assertEquals(webdriverUtils.getTitle(driver), excelUtils.readStringData("Sheet1", 3, 1), "Trello LoginPage Title is Not Matched");
	}
...
// Verify Login To Continue Page using URL
		Assert.assertTrue(webdriverUtils.getCurrentURL(driver).contains(excelUtils.readStringData("Sheet1", 4, 1)), "Trello Login To Continue Page URL is Not Matched");
// Verify Login To Continue Page using Title
		Assert.assertEquals(webdriverUtils.getTitle(driver), excelUtils.readStringData("Sheet1", 5, 1), "Trello Login To Continue Page Title is Not Matched");
...
// Verify Profile Boards Page using URL
		Assert.assertTrue(webdriverUtils.getCurrentURL(driver).contains("mayurmokal"), "Trello Profile Boards Page Title is Not Matched");
// Verify Profile Boards Page using Title
		Assert.assertEquals(webdriverUtils.getTitle(driver), excelUtils.readStringData("Sheet1", 7, 1), "Trello Profile Boards Page URL is Not Matched");
...
// Verify Logout Option is Enable
		Assert.assertTrue(boardPage.getLogoutOption().isEnabled(), "Trello Profile Board Page Logout Option is Not Visible and Clickable");
// Click on Logout Option
		boardPage.getLogoutOption().click();
// Verify the Logout Page using URL
		Assert.assertTrue(webdriverUtils.getCurrentURL(driver).contains(excelUtils.readStringData("Sheet1", 9, 1)), "Trello Logout Page URL is Not Matched");
// Verify the Logout Page using Title
		Assert.assertEquals(webdriverUtils.getTitle(driver), excelUtils.readStringData("Sheet1", 10, 1), "Trello Logout Page Title is Not Matched");
...
// Verify Login To Continue Page using URL
		Assert.assertTrue(webdriverUtils.getCurrentURL(driver).contains(excelUtils.readStringData("Sheet1", 4, 1)), "Trello Login To Continue Page URL is Not Matched");
// Verify Login To Continue Page using Title
		Assert.assertEquals(webdriverUtils.getTitle(driver), excelUtils.readStringData("Sheet1", 5, 1), "Trello Login To Continue Page Title is Not Matched");		TrelloLoginToContinuePage loginToContinuePage = new TrelloLoginToContinuePage(driver);
		webdriverUtils.waitForElementIsClickable(driver, loginToContinuePage.getPasswordTextfield());
// Enter the Password in Password Textfield
		loginToContinuePage.getPasswordTextfield().sendKeys(fileUtils.readCommonData("password"));
// Click on Login Button
...
// Verify Created Boards Page using URL
		...
		Assert.assertTrue(webdriverUtils.getCurrentURL(driver).contains("createboardone"), "Created Board Page URL is Not Matched");
...
// Click on Logout Option
		...
		Assert.assertTrue(webdriverUtils.getCurrentURL(driver).contains(excelUtils.readStringData("Sheet1", 8, 1)), "Atlassion Logout Page URL is Not Matched");
// Click on Atlassion Logout Button
		Assert.assertEquals(webdriverUtils.getTitle(driver), excelUtils.readStringData("Sheet1", 9, 1), "Atlassion Logout Page Title is Not Matched");
		logoutFromAtlassian.getfinalLogoutButton().click();
// Verify HomePage using URL
		webdriverUtils.waitForElementIsClickable(driver, homepage.getLoginOption());
		Assert.assertTrue(webdriverUtils.getCurrentURL(driver).contains("home"), "After Logout HomePage URL is Not Matched");
// Verify HomePage using Title
		Assert.assertEquals(webdriverUtils.getTitle(driver), excelUtils.readStringData("Sheet1", 1, 1), "Trello Homepage Title is Not Matched");			
	}
...
// Verify HomePage using Title
	...
	@Test
	public void trelloCreateMultipleListAndSwapInCreatedBoard() throws EncryptedDocumentException, IOException, InterruptedException {
		webdriverUtils.implicitWait(driver);
		// Verify HomePage using Title
				Assert.assertEquals(webdriverUtils.getTitle(driver), excelUtils.readStringData("Sheet1", 1, 1), "Trello Homepage Title is Not Matched");
				TrelloHomePage homepage = new TrelloHomePage(driver);
		...
		// Create 2 List
				...
				boardPage.getEnterListTitleTextfield().sendKeys(excelUtils.readStringData("CreatedBoard", 1, 2));
				boardPage.getAddListButton().click();
// Swapping Position of Lists1 and List2
				Thread.sleep(2000);
